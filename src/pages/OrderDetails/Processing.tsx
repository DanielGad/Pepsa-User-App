  ...
  return (
    <>
      <div className="flex justify-between lg:px-20 bg-red-50 items-center text-lg">
        <img src={OrderImage} alt="order" className="w-18" />
        <div className="flex flex-col justify-center">
          <h2 className="font-semibold">Order ID: {order.orderId}</h2>
          <p className="text-gray-500 mr-5">
            {dayjs(order.createdAt).format("Do MMMM YYYY")}
          </p>
        </div>
        <p className="font-semibold text-red-800 mr-5">{order.status}</p>
      </div>
          ...
          <div className="mt-10 flex flex-col md:flex-row justify-between gap-10 px-2 md:px-5">
            ...
            <div className="w-full md:w-3/5 flex flex-col gap-5 shadow-xl p-5 rounded-xl">
              ...
              <div className="flex justify-between text-gray-600">
                ...
                <p className="font-semibold">
                  ₦
                  {order.deliveryFee.toLocaleString(undefined, {
                    minimumFractionDigits: 2,
                  })}
                </p>
              </div>
              <div className="flex justify-between text-gray-600">
                ...
                <p className="font-semibold">
                  ₦
                  {order.serviceFee.toLocaleString(undefined, {
                    minimumFractionDigits: 2,
                  })}
                </p>
              </div>
